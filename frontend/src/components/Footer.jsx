    ...
    <div className="text-gray-500/80 pt-6 px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 mt-16 bg-slate-100">
      <div className="flex flex-wrap justify-between gap-10 sm:gap-12 md:gap-6">
        <div className="max-w-80">
          <img src={assets.logo} alt="logo" className="mb-4 h-8 sm:h-8 md:h-9 invert opacity-80" />
        ...
        <div className="max-w-80">
          ...
          <div className="flex items-center mt-4">
            <input
              type="text"
              className="bg-white rounded-l border border-gray-300 h-9 px-3 outline-none text-sm w-full max-w-[160px]"
